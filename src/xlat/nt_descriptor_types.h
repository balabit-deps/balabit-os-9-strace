...
static const struct xlat_data nt_descriptor_types_xdata[] = {
 ...
 XLAT(NT_ARM_VFP),
 #define XLAT_VAL_49 ((unsigned) (NT_ARM_VFP))
 #define XLAT_STR_49 STRINGIFY(NT_ARM_VFP)
 XLAT(NT_ARM_TLS),
 #define XLAT_VAL_50 ((unsigned) (NT_ARM_TLS))
 #define XLAT_STR_50 STRINGIFY(NT_ARM_TLS)
 XLAT(NT_ARM_HW_BREAK),
 #define XLAT_VAL_51 ((unsigned) (NT_ARM_HW_BREAK))
 #define XLAT_STR_51 STRINGIFY(NT_ARM_HW_BREAK)
 XLAT(NT_ARM_HW_WATCH),
 #define XLAT_VAL_52 ((unsigned) (NT_ARM_HW_WATCH))
 #define XLAT_STR_52 STRINGIFY(NT_ARM_HW_WATCH)
 XLAT(NT_ARM_SYSTEM_CALL),
 #define XLAT_VAL_53 ((unsigned) (NT_ARM_SYSTEM_CALL))
 #define XLAT_STR_53 STRINGIFY(NT_ARM_SYSTEM_CALL)
 XLAT(NT_ARM_SVE),
 #define XLAT_VAL_54 ((unsigned) (NT_ARM_SVE))
 #define XLAT_STR_54 STRINGIFY(NT_ARM_SVE)
 XLAT(NT_ARM_PAC_MASK),
 #define XLAT_VAL_55 ((unsigned) (NT_ARM_PAC_MASK))
 #define XLAT_STR_55 STRINGIFY(NT_ARM_PAC_MASK)
 XLAT(NT_ARM_PACA_KEYS),
 #define XLAT_VAL_56 ((unsigned) (NT_ARM_PACA_KEYS))
 #define XLAT_STR_56 STRINGIFY(NT_ARM_PACA_KEYS)
 XLAT(NT_ARM_PACG_KEYS),
 #define XLAT_VAL_57 ((unsigned) (NT_ARM_PACG_KEYS))
 #define XLAT_STR_57 STRINGIFY(NT_ARM_PACG_KEYS)
 XLAT(NT_ARM_TAGGED_ADDR_CTRL),
 #define XLAT_VAL_58 ((unsigned) (NT_ARM_TAGGED_ADDR_CTRL))
 #define XLAT_STR_58 STRINGIFY(NT_ARM_TAGGED_ADDR_CTRL)
 XLAT(NT_ARM_PAC_ENABLED_KEYS),
 #define XLAT_VAL_59 ((unsigned) (NT_ARM_PAC_ENABLED_KEYS))
 #define XLAT_STR_59 STRINGIFY(NT_ARM_PAC_ENABLED_KEYS)
 XLAT(NT_METAG_CBUF),
 #define XLAT_VAL_60 ((unsigned) (NT_METAG_CBUF))
 #define XLAT_STR_60 STRINGIFY(NT_METAG_CBUF)
 XLAT(NT_METAG_RPIPE),
 #define XLAT_VAL_61 ((unsigned) (NT_METAG_RPIPE))
 #define XLAT_STR_61 STRINGIFY(NT_METAG_RPIPE)
 XLAT(NT_METAG_TLS),
 #define XLAT_VAL_62 ((unsigned) (NT_METAG_TLS))
 #define XLAT_STR_62 STRINGIFY(NT_METAG_TLS)
 XLAT(NT_ARC_V2),
 #define XLAT_VAL_63 ((unsigned) (NT_ARC_V2))
 #define XLAT_STR_63 STRINGIFY(NT_ARC_V2)
 XLAT(NT_VMCOREDD),
 #define XLAT_VAL_64 ((unsigned) (NT_VMCOREDD))
 #define XLAT_STR_64 STRINGIFY(NT_VMCOREDD)
 XLAT(NT_MIPS_DSP),
 #define XLAT_VAL_65 ((unsigned) (NT_MIPS_DSP))
 #define XLAT_STR_65 STRINGIFY(NT_MIPS_DSP)
 XLAT(NT_MIPS_FP_MODE),
 #define XLAT_VAL_66 ((unsigned) (NT_MIPS_FP_MODE))
 #define XLAT_STR_66 STRINGIFY(NT_MIPS_FP_MODE)
 XLAT(NT_MIPS_MSA),
 #define XLAT_VAL_67 ((unsigned) (NT_MIPS_MSA))
 #define XLAT_STR_67 STRINGIFY(NT_MIPS_MSA)
 XLAT(NT_FILE),
 #define XLAT_VAL_68 ((unsigned) (NT_FILE))
 #define XLAT_STR_68 STRINGIFY(NT_FILE)
 XLAT(NT_PRXFPREG),
 #define XLAT_VAL_69 ((unsigned) (NT_PRXFPREG))
 #define XLAT_STR_69 STRINGIFY(NT_PRXFPREG)
 XLAT(NT_SIGINFO),
 #define XLAT_VAL_70 ((unsigned) (NT_SIGINFO))
 #define XLAT_STR_70 STRINGIFY(NT_SIGINFO)
};
static
