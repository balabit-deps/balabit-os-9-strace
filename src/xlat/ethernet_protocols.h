...
static const struct xlat_data ethernet_protocols_xdata[] = {
 ...
 XLAT(ETH_P_IFE),
 #define XLAT_VAL_95 ((unsigned) (ETH_P_IFE))
 #define XLAT_STR_95 STRINGIFY(ETH_P_IFE)
 XLAT(ETH_P_AF_IUCV),
 #define XLAT_VAL_96 ((unsigned) (ETH_P_AF_IUCV))
 #define XLAT_STR_96 STRINGIFY(ETH_P_AF_IUCV)
};
