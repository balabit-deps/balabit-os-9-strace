...
#endif
#if defined(NET_IPV4_CONF_ACCEPT_LOCAL) || (defined(HAVE_DECL_NET_IPV4_CONF_ACCEPT_LOCAL) && HAVE_DECL_NET_IPV4_CONF_ACCEPT_LOCAL)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((NET_IPV4_CONF_ACCEPT_LOCAL) == (23), "NET_IPV4_CONF_ACCEPT_LOCAL != 23");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define NET_IPV4_CONF_ACCEPT_LOCAL 23
#endif
#if defined(NET_IPV4_CONF_SRC_VMARK) || (defined(HAVE_DECL_NET_IPV4_CONF_SRC_VMARK) && HAVE_DECL_NET_IPV4_CONF_SRC_VMARK)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((NET_IPV4_CONF_SRC_VMARK) == (24), "NET_IPV4_CONF_SRC_VMARK != 24");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define NET_IPV4_CONF_SRC_VMARK 24
#endif
#if defined(NET_IPV4_CONF_PROXY_ARP_PVLAN) || (defined(HAVE_DECL_NET_IPV4_CONF_PROXY_ARP_PVLAN) && HAVE_DECL_NET_IPV4_CONF_PROXY_ARP_PVLAN)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((NET_IPV4_CONF_PROXY_ARP_PVLAN) == (25), "NET_IPV4_CONF_PROXY_ARP_PVLAN != 25");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
# define NET_IPV4_CONF_PROXY_ARP_PVLAN 25
#endif
#undef XLAT_PREV_VAL
...
static const struct xlat_data sysctl_net_ipv4_conf_xdata[] = {
 ...
 [NET_IPV4_CONF_ACCEPT_LOCAL] = XLAT(NET_IPV4_CONF_ACCEPT_LOCAL),
 #define XLAT_VAL_22 ((unsigned) (NET_IPV4_CONF_ACCEPT_LOCAL))
 #define XLAT_STR_22 STRINGIFY(NET_IPV4_CONF_ACCEPT_LOCAL)

 [NET_IPV4_CONF_SRC_VMARK] = XLAT(NET_IPV4_CONF_SRC_VMARK),
 #define XLAT_VAL_23 ((unsigned) (NET_IPV4_CONF_SRC_VMARK))
 #define XLAT_STR_23 STRINGIFY(NET_IPV4_CONF_SRC_VMARK)

 [NET_IPV4_CONF_PROXY_ARP_PVLAN] = XLAT(NET_IPV4_CONF_PROXY_ARP_PVLAN),
 #define XLAT_VAL_24 ((unsigned) (NET_IPV4_CONF_PROXY_ARP_PVLAN))
 #define XLAT_STR_24 STRINGIFY(NET_IPV4_CONF_PROXY_ARP_PVLAN)
};
static
